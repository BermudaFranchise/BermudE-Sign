const en = {
  ...
  document_signing_software: 'document signing software',
...
const es = {
  ...
  document_signing_software: 'software de firma de documentos',
...
const it = {
  ...
  document_signing_software: 'software di firma documenti',
...
const de = {
  ...
  document_signing_software: 'Dokumenten-Signatur-Software',
...
const fr = {
  ...
  document_signing_software: 'logiciel de signature de documents',
...
const pl = {
  ...
  document_signing_software: 'oprogramowanie do podpisywania dokumentów',
...
const uk = {
  ...
  document_signing_software: 'програмне забезпечення для підпису документів',
...
const cs = {
  ...
  document_signing_software: 'software pro podepisování dokumentů',
...
const pt = {
  ...
  document_signing_software: 'software de assinatura de documentos',
...
const he = {
  ...
  document_signing_software: 'תוכנה לחתימה על מסמכים',
...
const nl = {
  ...
  document_signing_software: 'Document ondertekening software',
...
const ar = {
  ...
  document_signing_software: 'برنامج توقيع المستندات',
...
const ko = {
  ...
  document_signing_software: '문서 서명 소프트웨어',
...
const ja = {
  ...
  document_signing_software: '文書署名ソフトウェア',
